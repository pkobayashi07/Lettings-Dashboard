...
import { createLandlord } from "@/lib/lettings/actions";
...
export function NewLandlordForm() {
  const [state, action, pending] = useActionState(createLandlord, undefined);
  ...
  return (
    <form action={action} className="space-y-3 rounded-xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
      <h2 className="text-sm font-semibold text-neutral-900 dark:text-neutral-50">Add landlord</h2>
