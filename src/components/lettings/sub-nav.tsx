...
const LINKS = [
  { href: "/lettings", label: "Pipeline" },
  { href: "/lettings/properties", label: "Properties" },
  { href: "/lettings/tenants", label: "Tenants" },
  { href: "/lettings/landlords", label: "Landlords" },
];

export function LettingsSubNav({ active }: { active: string }) {
  return (
