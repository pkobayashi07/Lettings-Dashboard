...
import { createContractor } from "@/lib/maintenance/actions";
...
export function NewContractorForm() {
  ...
  return (
    <form action={action} className="space-y-3 rounded-xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
      <h2 className="text-sm font-semibold text-neutral-900 dark:text-neutral-50">Add contractor</h2>
      <div className="grid gap-3 sm:grid-cols-4">
        ...
        <div>
          <label className={labelClass} htmlFor="trade">Trade</label>
          <input id="trade" name="trade" className={inputClass} placeholder="Plumbing" />
        </div>
        <div>
